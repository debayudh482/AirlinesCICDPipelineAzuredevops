...
1.  Retrieves the ADF source/configuration
2.  Validates/builds the solution
3.  Generates deployable ADF/ARM artifacts
4.  Publishes the artifact for the release stage
